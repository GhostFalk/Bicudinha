...
public class TelaGerenciarCliente extends JFrame {
    ...
    public TelaGerenciarCliente(ArrayList<Cliente> clientes) {
    ...
    public static void main(String[] args) {
        ArrayList<Cliente> listaFake = new ArrayList<>();
        listaFake.add(new Cliente("Marina", "marina@email.com", "111.111.111-11", "(11) 11111-1111"));
        listaFake.add(new Cliente("Nicolas", "nicolas@email.com", "222.222.222-22", "(22) 22222-2222"));
        SwingUtilities.invokeLater(() -> new TelaGerenciarCliente(listaFake).setVisible(true));
    }
}
